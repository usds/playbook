...
4. Design the system to be scalable and support anticipated future growth. 
5. Develop metrics that will measure how well the service is meeting user needs, at each step of the service
...
- How will this system grow and scale when needed?
