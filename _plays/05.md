...
When we collaborate in the open and publish our data publicly, we can improve SDG data infrastructure together. By building services more openly and publishing open data, we simplify the public’s access to civic services and information, allow the public to contribute easily, and enable reuse by entrepreneurs, nonprofits, other agencies, and the public.
