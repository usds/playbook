...
7. Create an API for third parties to interact with the service directly, when appropriate
8. Publish source code of projects or components online, when appropriate
9. Share your development process and progress publicly, when appropriate
